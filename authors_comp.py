...
class author:
    ...
    def mean_paragraph_length(self):
        ...
        Spliteamos por \n\n
            Spliteamos por ' '
                Contamos palabras y guardamos en una lista
                    Aumentamos total de párrafos
        Sumamos todas las palabras.
            Dividimos entre total párrafos.


        :return: The average number of words per paragraph. Se identifica con \n\n
        '''
